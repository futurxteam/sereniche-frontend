export const stories = [
  {
    ...
    headline: "Finding balance after burnout.",
    excerpt:
    ...
    heroImage: "/stories/9.png",
    portraitImage: "/stories/8.png",
    fullContent: [
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Maya was a high achiever who had long confused productivity with worth. Untangling those two things took time, honesty, and many moments of discomfort. But she showed up, every week, and that consistency became the foundation she hadn't known she was building.",
      },
      {
        type: "heading",
        text: "Rediscovering herself",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Where she is now",
      },
      {
        type: "paragraph",
        text: "Maya now works as a freelance designer, on her own terms. She still has hard days. But she has language for them now, and tools, and the knowledge that asking for support is not weakness. It is, she says, the bravest thing she ever did.",
      },
    ],
  },
  {
    ...
    fullContent: [
      {
        type: "paragraph",
        text: "Daniel came to Sereniche at 34, at the urging of a partner who felt like they couldn't reach him. He arrived sceptical. He was a problem-solver by nature and wasn't sure what talking could actually do. But he was willing to try.",
      },
      {
        type: "heading",
        text: "Understanding the walls",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "Growing up, vulnerability hadn't felt safe. He had learned, implicitly, that being needed was better than being known. Therapy gave him the space to question that equation.",
      },
      {
        type: "heading",
        text: "Opening up",
      ...
      {
        type: "paragraph",
        text: "He described the first conversation where he cried in front of his partner as one of the most terrifying and most important moments of his life. \"Nothing bad happened,\" he said, with some surprise. \"They just held my hand.\"",
      },
      {
        type: "heading",
